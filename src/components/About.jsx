      ...
      <div className="max-w-7xl flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full text-center md:text-left font-Poppins">
          ...
          <p className="mb-4 text-base text-primary leading-relaxed">
            At CeylonQuest, we are passionate about unveiling the true essence of Sri Lanka — an
            island rich in culture, history, and breathtaking landscapes. From the tranquil shores
            of the south coast to the lush highlands of the hill country, our mission is to guide
            travelers through authentic, immersive experiences.
          </p>
          <p className="mb-4 text-base text-primary leading-relaxed">
            We believe travel is more than just sightseeing — it's about storytelling, connection,
            and discovery. Whether you're a solo explorer, a nature enthusiast, or a cultural seeker,
            CeylonQuest curates every journey with care, local insight, and a deep love for the island
            we call home.
          </p>
          <p className="mb-4 text-base text-primary leading-relaxed">
